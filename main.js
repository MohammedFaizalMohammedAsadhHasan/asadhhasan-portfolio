...
const skills = [
    ...
    { name: 'Notepad++', icon: 'simple-icons:notepadplusplus', category: 'tools', desc: 'Professional document creation and formatting.' },
    { name: 'Notepad', icon: 'fluent:notepad-24-regular', category: 'tools', desc: 'Professional document creation and formatting.' },
    { name: 'VS Code', icon: 'logos:visual-studio-code', category: 'tools', desc: 'Professional document creation and formatting.' },
    { name: 'Windsurf', icon: 'simple-icons:windsurf', category: 'tools', desc: 'Professional document creation and formatting.' },
