...
const skills = [
    ...
    { name: 'CapCut', icon: 'simple-icons:capcut', category: 'design', desc: 'Video editing, motion graphics, and engaging multimedia content creation.' },
    { name: 'GitHub', icon: 'simple-icons:github', category: 'tools', desc: 'Version control, collaborative development, and CI/CD pipelines.' },
    ...
    { name: 'Notepad++', icon: 'vscode-icons:file-type-notepad-plus-plus', category: 'tools', desc: 'Professional document creation and formatting.' },
    { name: 'Notepad', icon: 'vscode-icons:file-type-notepad', category: 'tools', desc: 'Professional document creation and formatting.' },
    { name: 'VS Code', icon: 'logos:visual-studio-code', category: 'tools', desc: 'Professional document creation and formatting.' },
    { name: 'Windsurf', icon: 'vscode-icons:file-type-windsurf', category: 'tools', desc: 'Professional document creation and formatting.' },
