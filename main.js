...
const skills = [
    ...
    { name: 'Notepad', icon: 'logos:notepad', category: 'tools', desc: 'Professional document creation and formatting.' },
    { name: 'VS Code', icon: 'logos:visual-studio-code', category: 'tools', desc: 'Professional document creation and formatting.' },
    { name: 'Windsurf', icon: 'logos:windsurf-studio-code', category: 'tools', desc: 'Professional document creation and formatting.' },
